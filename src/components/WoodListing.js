...
function WoodListing({
  ...
  const columns = [
    {
      ...
      dataIndex: "srno",
      render: (t) => <div className="text-center dark:text-white text-sm">{t}</div>,
      sorter: {
    ...
    {
      title: <div className="text-center dark:text-white text-sm">Price</div>,
      dataIndex: "price",
      render: (t) => <div className="text-center dark:text-white text-sm">{t}</div>,
      sorter: {
    ...
    {
      title: <div className="text-center dark:text-white text-sm">CreatedAt</div>,
  ...
  const HandleDelete = (id) => {
    ...
    fetch(`${Base_Url}customizeSofa/deleteWood/${id}`, requestOptions)
