    ...
    <div className="flex justify-between p-2 md:ml-6 md:mr-6 relative">
      ...
      <div className="flex">
        ...
        <NavButton
          ...
          customFunc={() => {
            setOpenBoxes(OpenBoxes === "notification" ? "" : "notification");
          }}
          color={currentColor}
        ...
        {OpenBoxes === "notification" ? (
          <Notification setOpenBoxes={setOpenBoxes} />
        ) : (
          ""
        )}
        {OpenBoxes === "userProfile" ? (
          <UserProfile setOpenBoxes={setOpenBoxes} />
        ) : (
          ""
        )}
      </div>
